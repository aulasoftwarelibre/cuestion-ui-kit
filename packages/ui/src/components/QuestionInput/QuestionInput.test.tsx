...
describe("QuestionInput", () => {
  ...
  it("should tell to press SEND", () => {
    const wrapper = mountWithIntl(<QuestionInput handleOnSubmit={mockOnHandleSubmit} length={10} />);
  ...
  it("should wait to tell press SEND", () => {
    const wrapper = mountWithIntl(<QuestionInput handleOnSubmit={mockOnHandleSubmit} length={12} />);
    const input = wrapper.find(TextField).find("input");
