...
describe("SessionInput", () => {
  ...
  it("should render correctly", () => {
    const component = createComponentWithIntl(
      <SessionInput handleOnSubmit={mockOnHandleSubmit} length={4} />,
    ).toJSON();
  ...
  it("should tell to press ENTER", () => {
    ...
    expect(wrapper.find(TextField).prop("helperText")).toStrictEqual(
      "and press ENTER.",
    );
  });
  ...
  it("should tell to wait until fill code", () => {
    const wrapper = mountWithIntl(
      <SessionInput handleOnSubmit={mockOnHandleSubmit} length={6} />,
    );
    wrapper
      .find(TextField)
      .find("input")
